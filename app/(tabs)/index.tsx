...
import { useAuth } from '@/lib/clerk'; // Updated import for Clerk authentication
...
export default function HomeScreen() {
  ...
  const { user } = useAuth(); // Get user from Clerk auth context
        ...
        <View className="bg-white mt-4 rounded-2xl p-4 shadow-xl">
          <View className="flex-row items-center">
            ...
            <View className="flex-1">
              <Text className="font-bold text-lg text-gray-800">Health Assistant</Text>
      ...
      <ScrollView className="flex-1 bg-gray-50 px-5 pt-6">
        ...
        <View className="mb-6">
          <View className="flex-row justify-between items-center mb-3">
            <Text className="text-xl font-bold text-gray-800">Your Health</Text>
            <TouchableOpacity>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View className="flex-row space-x-4 pb-2">
              ...
              <TouchableOpacity className="bg-white rounded-xl p-4 shadow-sm w-32 items-center">
                ...
                <Text className="text-2xl font-bold text-gray-800">8,546</Text>
              ...
              <TouchableOpacity className="bg-white rounded-xl p-4 shadow-sm w-32 items-center">
                ...
                <Text className="text-2xl font-bold text-gray-800">7.5h</Text>
                <Text className="text-gray-500 text-sm">Sleep</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity className="bg-white rounded-xl p-4 shadow-sm w-32 items-center">
                ...
                <Text className="text-2xl font-bold text-gray-800">1.2L</Text>
                <Text className="text-gray-500 text-sm">Hydration</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </View>
        ...
        <View className="mb-8">
          ...
          <View className="flex-row justify-between">
            ...
            >
              ...
              <Text className="text-gray-800 font-medium text-sm">Chat</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity className="bg-white rounded-xl shadow-sm p-3 items-center w-[30%]">
              ...
              <Text className="text-gray-800 font-medium text-sm">Reminders</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity className="bg-white rounded-xl shadow-sm p-3 items-center w-[30%]">
              ...
              <Text className="text-gray-800 font-medium text-sm">Progress</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View className="mb-8">
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-xl font-bold text-gray-800">Health Topics</Text>
            <TouchableOpacity>
              ...
              {healthTopics.map(topic => (
                ...
                >
                  ...
                  >
                    ...
                    <View>
                      <Text className="text-white font-bold text-lg">{topic.title}</Text>
                      <View className="flex-row items-center mt-1">
                        <Text className="text-white text-xs opacity-80">Learn more</Text>
        ...
        {/* Health Tips */}
        <View className="mb-8">
          <Text className="text-xl font-bold text-gray-800 mb-4">Daily Health Tips</Text>
          ...
          {healthTips.map((tip, index) => (
            ...
            >
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="font-bold text-gray-800 text-lg">{tip.title}</Text>
                  <Text className="text-gray-600">{tip.description}</Text>
                </View>
        ...
        <View className="mb-8">
          ...
          >
            <View className="flex-row items-center">
              <View className="flex-1">
                <Text className="text-white font-bold text-xl mb-2">Join Our Health Community</Text>
                <Text className="text-white opacity-90 mb-4">Connect with others on your wellness journey</Text>
                <TouchableOpacity className="bg-white self-start py-2 px-4 rounded-lg">
                  <Text className="text-blue-600 font-bold">Join Now</Text>
                </TouchableOpacity>
              </View>
